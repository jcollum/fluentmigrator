...
namespace FluentMigrator.Runner.Initialization
{
    public class RunnerContext : IRunnerContext
    {
        ...
        public string VcsBasePath { get; set; }
        ...
        public IMigrationProcessor Processor
        {
            get
            {
                ...
                //// make a source control if needed 
                //if (!string.IsNullOrEmpty(this.VcsBasePath))
                //{
                //    if (this.VcsType.ToLowerInvariant() == "svn")
                //    {
                //        _processor.SourceControl = new FluentMigrator.SourceControl.Svn() { BasePath = this.VcsBasePath };
                //    }
                //    else throw new NotImplementedException("Svn is the only source control type supported at the moment.");
                //}
